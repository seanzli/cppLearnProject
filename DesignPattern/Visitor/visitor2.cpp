...
class Visitor {
public:
    Visitor(std::string name) : visitor_name(name) {}

    virtual void visitCPU(CPU* cpu) {}
    virtual void visitVideoCard(VideoCard* video_card) {}
    virtual void visitMainBoard(MainBoard* main_board) {}
...
class Element {
public:
    Element(std::string name) : ele_name(name) {}
